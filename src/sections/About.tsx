    ...
    <div className="flex flex-col bg-green-900 text-orange-300 p-10 gap-2 ">
      <div className="max-w-2xl mx-auto">
        ...
        <p>Under årens gång så har jag arbetat inom vården, servitör och som murare nästan alltid i team. Har väldigt lätt att komma in i ett bra flyt och sammanhang med dem runtomkring mig.<br />
          ...
          <br />
          <p>Att nå ut och få min ambition att lysa lika mycket i text som i verkliga livet är något jag
            gör bättre för var dag som går.<br />
            Jag hoppas det kan göra det med mina projekt som jag har gjort under skoltiden.<br />
            Aldrig rört kod innan sommaren 2025, nu är det ungefär det enda jag gör om fritiden, det är ambitionen
            nyfikenheten och viljan att veta som driver mig. Jag vill verkligen förstå, uppleva hur saker och ting fungerar och vävs isamman.</p>
          <br />
