  ...
  return (
    <div className='flex flex-col bg-green-900 text-orange-300 p-10'>
      <div className="max-w-2xl mx-auto flex flex-col gap-8">
        <h1 className="text-orange-500 text-3xl">🛠️ Mina projekt</h1>

        {/* Skolprojekt */}
        <h2 className="text-yellow-200 text-2xl">🎓 Skolprojekt</h2>
        ...
        {/* Egna projekt */}
        <h2 className="text-yellow-200 text-2xl">🔨 Egna projekt</h2>
